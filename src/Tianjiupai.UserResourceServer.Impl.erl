...
'init_impl'(S2598Arg) -> 'Tianjiupai.UserResourceServer.Callback':'init'(S2598Arg).
      init(Args) ->
...
'handle_call_impl'(S2601Req, S2602Pid, S2603State) -> 'Tianjiupai.UserResourceServer.Callback':'handle_call'(S2601Req, S2602Pid, S2603State).
...
'handle_cast_impl'(S2606Msg, S2607State) -> 'Tianjiupai.UserResourceServer.Callback':'handle_cast'(S2606Msg, S2607State).
...
'handle_info_impl'(S2611Info, S2612State) -> 'Tianjiupai.UserResourceServer.Callback':'handle_info'(S2611Info, S2612State).
'handle_timeout_impl'(S2614State) -> 'Tianjiupai.UserResourceServer.Callback':'handle_timeout'(S2614State).
'handle_down_impl'(S2616Mref, S2617Pid, S2618Reason, S2619State) -> 'Tianjiupai.UserResourceServer.Callback':'handle_down'(S2616Mref, S2617Pid, S2618Reason, S2619State).
...
'terminate_impl'(S2622Reason, S2623State) -> 'Tianjiupai.UserResourceServer.Callback':'terminate'(S2622Reason, S2623State).
...
'as_pid'(S2628Proc) -> S2628Proc.
'from_pid'(S2630Pid) -> S2630Pid.
      start_link(Args) ->
...
'send_info'(S2637Pid, S2638Info) -> sesterl_internal_prim:'send'(S2637Pid, S2638Info).
