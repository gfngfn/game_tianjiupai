...
-export(['disconnection_timeout'/0, 'maximum_num_innings'/0, 'room_expiration_timeout'/0, 'user_expiration_timeout'/0, 'maximum_num_rooms'/0, 'maximum_num_users'/0, 'maximum_num_rooms_per_user'/0]).
