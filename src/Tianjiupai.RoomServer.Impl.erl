...
'init_impl'(S2048Arg) -> 'Tianjiupai.RoomServer.Callback':'init'(S2048Arg).
      init(Args) ->
...
'handle_call_impl'(S2051Req, S2052Pid, S2053State) -> 'Tianjiupai.RoomServer.Callback':'handle_call'(S2051Req, S2052Pid, S2053State).
...
'handle_cast_impl'(S2056Msg, S2057State) -> 'Tianjiupai.RoomServer.Callback':'handle_cast'(S2056Msg, S2057State).
...
'handle_info_impl'(S2061Info, S2062State) -> 'Tianjiupai.RoomServer.Callback':'handle_info'(S2061Info, S2062State).
'handle_timeout_impl'(S2064State) -> 'Tianjiupai.RoomServer.Callback':'handle_timeout'(S2064State).
'handle_down_impl'(S2066Mref, S2067Pid, S2068Reason, S2069State) -> 'Tianjiupai.RoomServer.Callback':'handle_down'(S2066Mref, S2067Pid, S2068Reason, S2069State).
...
'terminate_impl'(S2072Reason, S2073State) -> 'Tianjiupai.RoomServer.Callback':'terminate'(S2072Reason, S2073State).
...
'as_pid'(S2078Proc) -> S2078Proc.
'from_pid'(S2080Pid) -> S2080Pid.
      start_link(Args) ->
...
'send_info'(S2087Pid, S2088Info) -> sesterl_internal_prim:'send'(S2087Pid, S2088Info).
