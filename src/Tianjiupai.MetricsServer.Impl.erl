...
'init_impl'(S2719Arg) -> 'Tianjiupai.MetricsServer.Callback':'init'(S2719Arg).
      init(Args) ->
...
'handle_call_impl'(S2722Req, S2723Pid, S2724State) -> 'Tianjiupai.MetricsServer.Callback':'handle_call'(S2722Req, S2723Pid, S2724State).
...
'handle_cast_impl'(S2727Msg, S2728State) -> 'Tianjiupai.MetricsServer.Callback':'handle_cast'(S2727Msg, S2728State).
...
'handle_info_impl'(S2732Info, S2733State) -> 'Tianjiupai.MetricsServer.Callback':'handle_info'(S2732Info, S2733State).
'handle_timeout_impl'(S2735State) -> 'Tianjiupai.MetricsServer.Callback':'handle_timeout'(S2735State).
'handle_down_impl'(S2737Mref, S2738Pid, S2739Reason, S2740State) -> 'Tianjiupai.MetricsServer.Callback':'handle_down'(S2737Mref, S2738Pid, S2739Reason, S2740State).
...
'terminate_impl'(S2743Reason, S2744State) -> 'Tianjiupai.MetricsServer.Callback':'terminate'(S2743Reason, S2744State).
...
'as_pid'(S2749Proc) -> S2749Proc.
'from_pid'(S2751Pid) -> S2751Pid.
      start_link(Args) ->
...
'send_info'(S2758Pid, S2759Info) -> sesterl_internal_prim:'send'(S2758Pid, S2759Info).
