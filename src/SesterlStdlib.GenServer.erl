...
'init_ok'(S164State, S2979) -> S165TimeoutOpt = sesterl_internal_prim:decode_option(S2979, timeout), sesterl_internal_prim:'return'({'ok', {S164State, S165TimeoutOpt}}).
...
'reply'(S169Response, S170State, S2981) -> S171Timeout = sesterl_internal_prim:decode_option(S2981, timeout), sesterl_internal_prim:'return'({'reply_impl', S169Response, S170State, S171Timeout}).
...
'no_reply'(S177State, S2983) -> S178Timeout = sesterl_internal_prim:decode_option(S2983, timeout), sesterl_internal_prim:'return'({'no_reply_impl', S177State, S178Timeout}).
