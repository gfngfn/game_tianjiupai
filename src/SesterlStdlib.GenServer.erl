...
'init_ok'(S164State, S2987) -> S165TimeoutOpt = sesterl_internal_prim:decode_option(S2987, timeout), sesterl_internal_prim:'return'({'ok', {S164State, S165TimeoutOpt}}).
...
'reply'(S169Response, S170State, S2989) -> S171Timeout = sesterl_internal_prim:decode_option(S2989, timeout), sesterl_internal_prim:'return'({'reply_impl', S169Response, S170State, S171Timeout}).
...
'no_reply'(S177State, S2991) -> S178Timeout = sesterl_internal_prim:decode_option(S2991, timeout), sesterl_internal_prim:'return'({'no_reply_impl', S177State, S178Timeout}).
