...
'init_ok'(S164State, S2876) -> S165TimeoutOpt = sesterl_internal_prim:decode_option(S2876, timeout), sesterl_internal_prim:'return'({'ok', {S164State, S165TimeoutOpt}}).
...
'reply'(S169Response, S170State, S2878) -> S171Timeout = sesterl_internal_prim:decode_option(S2878, timeout), sesterl_internal_prim:'return'({'reply_impl', S169Response, S170State, S171Timeout}).
...
'no_reply'(S177State, S2880) -> S178Timeout = sesterl_internal_prim:decode_option(S2880, timeout), sesterl_internal_prim:'return'({'no_reply_impl', S177State, S178Timeout}).
